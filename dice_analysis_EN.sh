...
while [ 0 ]; do
	...
	tput cup 20 48
	echo -e "\033[0;0;37mDifference average (Ø): \033[0;1;35m$duc"    
	read -sn1 hallo
	
	tput cup 20 1
	echo -e "\033[0;0;37mAccuracy quota:      \033[0;1;32m$duv%"
	tput cup 22 1
	echo -e "\033[0;0;37mIrregularity quota:  \033[0;1;31m$du%"
	...
	klaro
	tput cup 10 9
	echo -e "\033[0;1;31mYou have to roll at least 400 and no more than 9999 times.\033[0m"
	read -sn1 hallo
    fi
